...
>
    ...
    <div class="flex items-center gap-3">
        <input type="checkbox" name="is_active" id="is_active" value="1" class="w-5 h-5 text-primary-700 border-slate-300 rounded focus:ring-primary-500" {{ old('is_active', $department->is_active ?? true) ? 'checked' : '' }}>
