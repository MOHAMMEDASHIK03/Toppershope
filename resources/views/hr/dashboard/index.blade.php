...
<div class="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
    <a href="{{ route('hr.employees.create') }}" class="flex flex-col items-center gap-2 p-5 bg-white rounded-2xl border border-slate-100 shadow-sm hover:border-indigo-200 hover:bg-orange-50/50 transition-all group">
    ...
    <a href="{{ route('hr.payroll.create') }}" class="flex flex-col items-center gap-2 p-5 bg-white rounded-2xl border border-slate-100 shadow-sm hover:border-emerald-200 hover:bg-emerald-50/50 transition-all group">
    ...
    <a href="{{ route('hr.attendance.index') }}" class="flex flex-col items-center gap-2 p-5 bg-white rounded-2xl border border-slate-100 shadow-sm hover:border-blue-200 hover:bg-orange-50/50 transition-all group">
