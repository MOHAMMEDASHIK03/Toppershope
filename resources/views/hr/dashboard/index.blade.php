...
<div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5 mb-8">
    ...
    <div class="bg-white rounded-2xl p-5 border border-slate-100 shadow-sm flex items-center gap-4">
        ...
        <div>
            ...
            <p class="text-2xl font-black text-slate-800">{{ $pendingLeaves }}</p>
    ...
    <div class="bg-white rounded-2xl p-5 border border-slate-100 shadow-sm flex items-center gap-4">
        ...
        <div>
            ...
            <p class="text-2xl font-black text-slate-800">{{ $openJobPostings }}</p>
            <p class="text-[11px] text-primary-600 font-bold">Active job postings</p>
        </div>
    </div>
    ...
    <div class="bg-white rounded-2xl p-5 border border-slate-100 shadow-sm flex items-center gap-4">
        ...
        <div>
            ...
            <p class="text-2xl font-black text-slate-800">₹{{ number_format($thisMonthPayroll) }}</p>
        </div>
    </div>
...
<div class="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
    <a href="{{ route('hr.employees.create') }}" class="flex flex-col items-center gap-2 p-5 bg-white rounded-2xl border border-slate-100 shadow-sm hover:border-primary-200 hover:bg-primary-50/50 transition-all group">
        <div class="w-10 h-10 rounded-xl bg-primary-100 text-primary-700 flex items-center justify-center group-hover:scale-110 transition-transform">
    ...
    <a href="{{ route('hr.payroll.create') }}" class="flex flex-col items-center gap-2 p-5 bg-white rounded-2xl border border-slate-100 shadow-sm hover:border-emerald-200 hover:bg-primary-50/50 transition-all group">
        <div class="w-10 h-10 rounded-xl bg-emerald-100 text-primary-600 flex items-center justify-center group-hover:scale-110 transition-transform">
    ...
    <a href="{{ route('hr.leaves.index') }}" class="flex flex-col items-center gap-2 p-5 bg-white rounded-2xl border border-slate-100 shadow-sm hover:border-amber-200 hover:bg-amber-50/50 transition-all group">
    ...
    <a href="{{ route('hr.attendance.index') }}" class="flex flex-col items-center gap-2 p-5 bg-white rounded-2xl border border-slate-100 shadow-sm hover:border-primary-200 hover:bg-primary-50/50 transition-all group">
        <div class="w-10 h-10 rounded-xl bg-primary-100 text-primary-700 flex items-center justify-center group-hover:scale-110 transition-transform">
...
<div class="bg-white rounded-2xl border border-slate-100 shadow-sm p-8 text-center">
    <div class="w-14 h-14 rounded-full bg-primary-50 flex items-center justify-center text-primary-500 mx-auto mb-4">
