    ...
    <div class="bg-white rounded-2xl border border-slate-200 shadow-sm p-6">
        <div class="flex items-center gap-3 mb-6">
            <div class="w-10 h-10 rounded-xl bg-primary-50 flex items-center justify-center">
                <i class="ph-fill ph-browser text-primary-500 text-xl"></i>
            </div>
            <div>
        ...
        <form method="POST" action="{{ route('ads.popups.update') }}" enctype="multipart/form-data" class="space-y-5">
            ...
            <div>
                ...
                <input type="file" name="image" accept="image/*"
                       class="w-full text-sm text-slate-500 file:mr-3 file:py-2 file:px-4 file:rounded-xl file:border-0 file:bg-primary-50 file:text-primary-700 file:font-bold hover:file:bg-primary-100 transition">
            </div>
            ...
            <div class="grid grid-cols-2 gap-5">
                <div>
                    ...
                    <input type="number" name="delay_seconds" value="{{ $popup->delay_seconds }}" min="0" max="30"
                           class="w-full px-4 py-3 border border-slate-200 rounded-xl text-slate-900 focus:outline-none focus:ring-2 focus:ring-primary-500/40 focus:border-primary-500 bg-slate-50 transition">
                </div>
                <div>
            ...
            <div class="flex items-center justify-between pt-2">
                ...
                <button type="submit" class="px-7 py-2.5 bg-primary-500 hover:bg-primary-700 text-white font-black rounded-xl transition shadow-md shadow-primary-500/25 text-sm">
                    Save Settings
                </button>
            </div>
        </form>
