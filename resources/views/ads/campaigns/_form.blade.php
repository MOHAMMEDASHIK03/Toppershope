...
<div class="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden">
    <div class="px-6 py-4 border-b border-slate-100 flex items-center gap-2">
        <div class="w-7 h-7 rounded-lg bg-primary-100 flex items-center justify-center text-primary-500 text-sm font-black">1</div>
    ...
    <div class="p-6 grid grid-cols-1 sm:grid-cols-2 gap-4">
        <div class="sm:col-span-2">
            ...
            <input type="text" name="title" value="{{ $v('title') }}" required
                   ...
                   class="w-full px-4 py-2.5 border border-slate-200 rounded-xl text-slate-900 text-sm focus:outline-none focus:ring-2 focus:ring-primary-500/30 focus:border-primary-500 bg-slate-50 hover:bg-white transition">
        </div>
        <div>
            ...
            <input type="text" name="subtitle" value="{{ $v('subtitle') }}"
                   ...
                   class="w-full px-4 py-2.5 border border-slate-200 rounded-xl text-slate-900 text-sm focus:outline-none focus:ring-2 focus:ring-primary-500/30 focus:border-primary-500 bg-slate-50 transition">
        </div>
        <div>
        ...
        <div>
            ...
            <input type="file" name="hero_image" accept="image/*"
                   class="w-full text-xs text-slate-500 file:mr-3 file:py-1.5 file:px-3 file:rounded-lg file:border-0 file:bg-primary-50 file:text-primary-700 file:font-bold hover:file:bg-primary-100 transition">
        </div>
        <div class="sm:col-span-2">
            ...
            <textarea name="description" rows="4" placeholder="Full campaign description shown on the landing page..."
                      class="w-full px-4 py-2.5 border border-slate-200 rounded-xl text-slate-900 text-sm focus:outline-none focus:ring-2 focus:ring-primary-500/30 focus:border-primary-500 bg-slate-50 transition resize-none">{{ $v('description') }}</textarea>
        </div>
        <div class="sm:col-span-2">
            ...
            <textarea name="features" rows="5"
                      ...
                      class="w-full px-4 py-2.5 border border-slate-200 rounded-xl text-slate-900 text-sm font-mono focus:outline-none focus:ring-2 focus:ring-primary-500/30 focus:border-primary-500 bg-slate-50 transition resize-none">{{ $features }}</textarea>
        </div>
    </div>
</div>
...
<div class="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden">
    <div class="px-6 py-4 border-b border-slate-100 flex items-center gap-2">
        <div class="w-7 h-7 rounded-lg bg-primary-100 flex items-center justify-center text-primary-500 text-sm font-black">2</div>
...
<div class="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden"
    ...
    <div class="px-6 py-4 border-b border-slate-100 flex items-center justify-between">
        <div class="flex items-center gap-2">
            <div class="w-7 h-7 rounded-lg bg-primary-100 flex items-center justify-center text-primary-500 text-sm font-black">3</div>
        ...
        <button type="button" @click="stats.push({label:'',value:''})"
                class="text-xs font-bold text-primary-500 hover:text-primary-700 flex items-center gap-1">
            + Add Stat
        </button>
    </div>
                ...
                <div class="flex-1 grid grid-cols-2 gap-3">
                    <div>
                        ...
                        <input type="text" :name="`stats[${i}][value]`" x-model="stat.value"
                               placeholder="500+" 
                               class="w-full px-3 py-2 border border-slate-200 rounded-xl text-slate-900 text-sm focus:outline-none focus:ring-2 focus:ring-primary-500/30 focus:border-primary-500 bg-slate-50 transition">
                    </div>
                    <div>
...
<div class="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden">
    <div class="px-6 py-4 border-b border-slate-100 flex items-center gap-2">
        <div class="w-7 h-7 rounded-lg bg-primary-100 flex items-center justify-center text-primary-500 text-sm font-black">4</div>
    ...
    <div class="p-6 grid grid-cols-1 sm:grid-cols-2 gap-4">
        ...
        <div>
            ...
            @if($editing && $campaign?->faculty_photo)
                <img src="{{ Storage::url($campaign->faculty_photo) }}" class="w-16 h-16 rounded-full object-cover border-2 border-primary-200 mb-2">
            @endif
        ...
        <div class="sm:col-span-2">
            ...
            <textarea name="faculty_bio" rows="3"
                      ...
                      class="w-full px-4 py-2.5 border border-slate-200 rounded-xl text-slate-900 text-sm focus:outline-none focus:ring-2 focus:ring-primary-500/30 focus:border-primary-500 bg-slate-50 transition resize-none">{{ $v('faculty_bio') }}</textarea>
        </div>
    </div>
</div>
            ...
            <div class="border border-slate-200 rounded-2xl p-4 bg-slate-50 relative">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-3 gap-3 mb-3">
                    <div>
                        ...
                        <input type="text" :name="`testimonials[${i}][name]`" x-model="t.name"
                               ...
                               class="w-full px-3 py-2 border border-slate-200 rounded-xl bg-white text-sm text-slate-900 focus:outline-none focus:ring-2 focus:ring-primary-500/30 focus:border-primary-500 transition">
                    </div>
                    <div>
                ...
                <div>
                    ...
                    <textarea :name="`testimonials[${i}][quote]`" x-model="t.quote" rows="2"
                              ...
                              class="w-full px-3 py-2 border border-slate-200 rounded-xl bg-white text-sm text-slate-900 focus:outline-none focus:ring-2 focus:ring-primary-500/30 focus:border-primary-500 transition resize-none"></textarea>
                </div>
            </div>
        </template>
    </div>
...
{{-- Colour theme: locked to Topper's Hope brand purple (not customizable) --}}
...
<div class="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden"
    ...
    <div class="px-6 py-4 border-b border-slate-100 flex items-center gap-2">
        <div class="w-7 h-7 rounded-lg bg-primary-100 flex items-center justify-center text-primary-600 text-sm font-black">7</div>
    ...
    <div class="p-6 space-y-4">
        <div class="grid grid-cols-3 gap-3">
            ...
            <label class="relative cursor-pointer">
                ...
                <div :class="popupType === '{{ $val }}' ? 'border-primary-500 bg-primary-50 text-primary-700' : 'border-slate-200 text-slate-500 hover:border-primary-200'"
        ...
        <div>
            ...
            <input type="number" name="popup_delay_seconds" value="{{ $v('popup_delay_seconds', 3) }}" min="0" max="30"
                   class="w-28 px-3 py-2 border border-slate-200 rounded-xl text-slate-900 text-sm focus:outline-none focus:ring-2 focus:ring-primary-500/30 focus:border-primary-500 bg-slate-50 transition">
        </div>
    </div>
</div>
...
<div class="flex items-center justify-between gap-4 bg-white rounded-2xl border border-slate-200 shadow-sm px-6 py-4">
    ...
    <div class="flex items-center gap-3">
        ...
        <button type="submit"
                ...
                style="background: linear-gradient(135deg, #7723D6, #fb923c)">
