<form method="POST" action="{{ route('admission.contacts.trial.issue', $contact) }}" class="space-y-4">
    ...
    <div>
        ...
        <select name="batch_id" required class="w-full px-3 py-2 border border-slate-200 rounded-xl text-sm outline-none focus:border-primary-600 focus:ring-1 focus:ring-primary-500 bg-slate-50">
    ...
    <div>
        ...
        <input type="email" name="trial_email" required
               ...
               class="w-full px-3 py-2 border border-slate-200 rounded-xl text-sm outline-none focus:border-primary-600 focus:ring-1 focus:ring-primary-500 font-mono">
    ...
    <div>
        ...
        <input type="number" name="days" value="5" min="1" max="30" required
               class="w-full px-3 py-2 border border-slate-200 rounded-xl text-sm outline-none focus:border-primary-600 focus:ring-1 focus:ring-primary-500">
    </div>
    <button type="submit"
            class="w-full py-2.5 bg-primary-50 text-primary-700 font-black text-sm rounded-xl hover:bg-primary-100 transition border border-primary-200">
        Issue Trial Access
    </button>
</form>
