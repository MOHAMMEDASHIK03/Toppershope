...
<a href="{{ route('hr.dashboard') }}" class="sidebar-link {{ request()->routeIs('hr.dashboard') ? 'active' : '' }}" title="Dashboard">
...
<a href="{{ route('hr.employees.index') }}" class="sidebar-link {{ request()->routeIs('hr.employees.*') ? 'active' : '' }}" title="Employees">
    <i class="ph ph-users"></i>
    <span class="sidebar-link-text truncate">Employees</span>
</a>
<a href="{{ route('hr.departments.index') }}" class="sidebar-link {{ request()->routeIs('hr.departments.*') ? 'active' : '' }}" title="Departments">
    <i class="ph ph-buildings"></i>
    <span class="sidebar-link-text truncate">Departments</span>
</a>
<a href="{{ route('hr.designations.index') }}" class="sidebar-link {{ request()->routeIs('hr.designations.*') ? 'active' : '' }}" title="Designations">
...
<a href="{{ route('hr.attendance.index') }}" class="sidebar-link {{ request()->routeIs('hr.attendance.*') ? 'active' : '' }}" title="Attendance">
    <i class="ph ph-clock"></i>
    <span class="sidebar-link-text truncate">Attendance</span>
</a>
<a href="{{ route('hr.leaves.index') }}" class="sidebar-link {{ request()->routeIs('hr.leaves.*') ? 'active' : '' }}" title="Leave requests">
    <i class="ph ph-calendar-x"></i>
    <span class="sidebar-link-text truncate">Leave Requests</span>
</a>
<a href="{{ route('hr.leave-types.index') }}" class="sidebar-link {{ request()->routeIs('hr.leave-types.*') ? 'active' : '' }}" title="Leave policies">
...
<a href="{{ route('hr.payroll.index') }}" class="sidebar-link {{ request()->routeIs('hr.payroll.*') && ! request()->routeIs('hr.payroll.settings*') ? 'active' : '' }}" title="Payroll runs">
    <i class="ph ph-wallet"></i>
    <span class="sidebar-link-text truncate">Payroll Runs</span>
</a>
<a href="{{ route('hr.payroll.settings') }}" class="sidebar-link {{ request()->routeIs('hr.payroll.settings*') ? 'active' : '' }}" title="Payroll settings">
...
<a href="{{ route('hr.kpis.index') }}" class="sidebar-link {{ request()->routeIs('hr.kpis.*') ? 'active' : '' }}" title="KPI Framework">
    <i class="ph ph-chart-bar"></i>
    <span class="sidebar-link-text truncate">KPI Framework</span>
</a>
<a href="{{ route('hr.performance-reviews.index') }}" class="sidebar-link {{ request()->routeIs('hr.performance-reviews.*') ? 'active' : '' }}" title="Reviews">
...
<a href="{{ route('hr.job-postings.index') }}" class="sidebar-link {{ request()->routeIs('hr.job-postings.*') ? 'active' : '' }}" title="Careers">
    <i class="ph ph-briefcase"></i>
    <span class="sidebar-link-text truncate">Careers Hub</span>
</a>
<a href="{{ route('hr.job-applications.index') }}" class="sidebar-link {{ request()->routeIs('hr.job-applications.*') || request()->routeIs('hr.interviews.*') ? 'active' : '' }}" title="Applicants">
...
<a href="{{ route('hr.employee-documents.index') }}" class="sidebar-link {{ request()->routeIs('hr.employee-documents.*') ? 'active' : '' }}" title="Documents">
    <i class="ph ph-files"></i>
    <span class="sidebar-link-text truncate">Documents</span>
</a>
<a href="{{ route('hr.announcements.index') }}" class="sidebar-link {{ request()->routeIs('hr.announcements.*') ? 'active' : '' }}" title="Announcements">
