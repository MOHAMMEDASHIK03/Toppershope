...
@if(Auth::user()->isFacultyHead())
    ...
    <a href="{{ route('faculty.head.courses.index') }}" class="sidebar-link {{ request()->routeIs('faculty.head.courses.*') ? 'active' : '' }}" title="Master courses">
        <i class="ph ph-books"></i>
        <span class="sidebar-link-text truncate">Master Courses</span>
    </a>
    <a href="{{ route('faculty.head.batches.index') }}" class="sidebar-link {{ request()->routeIs('faculty.head.batches.index') || request()->routeIs('faculty.head.batches.edit') || request()->routeIs('faculty.head.batches.store') || request()->routeIs('faculty.head.batches.update') || request()->routeIs('faculty.head.batches.destroy') ? 'active' : '' }}" title="Batches">
        <i class="ph ph-users-three"></i>
        <span class="sidebar-link-text truncate">Batches</span>
    </a>
    <a href="{{ route('faculty.head.faculties.index') }}" class="sidebar-link {{ request()->routeIs('faculty.head.faculties.index') || request()->routeIs('faculty.head.faculties.unassign') ? 'active' : '' }}" title="Faculties">
        <i class="ph ph-chalkboard-teacher"></i>
        <span class="sidebar-link-text truncate">Faculties</span>
    </a>
    <a href="{{ route('faculty.head.students.index') }}" class="sidebar-link {{ request()->routeIs('faculty.head.students.*') ? 'active' : '' }}" title="Students">
...
<a href="{{ route('faculty.my-courses') }}" class="sidebar-link {{ request()->routeIs('faculty.my-courses') || request()->routeIs('faculty.courses.*') ? 'active' : '' }}" title="My assigned courses">
