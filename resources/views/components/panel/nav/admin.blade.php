...
<a href="{{ route('admin.audit-logs.index') }}" class="sidebar-link {{ request()->routeIs('admin.audit-logs.*') ? 'active' : '' }}" title="Audit Logs">
...
<a href="{{ route('admin.academic.index') }}" class="sidebar-link {{ request()->routeIs('admin.academic.index') ? 'active' : '' }}" title="Academic overview">
    <i class="ph ph-chart-pie"></i>
    <span class="sidebar-link-text truncate">Academic Overview</span>
</a>
<a href="{{ route('admin.courses.create') }}" class="sidebar-link {{ request()->routeIs('admin.courses.*') ? 'active' : '' }}" title="Manage courses">
    <i class="ph ph-graduation-cap"></i>
    <span class="sidebar-link-text truncate">Courses & Batches</span>
</a>
<a href="{{ route('admin.categories.index') }}" class="sidebar-link {{ request()->routeIs('admin.categories.*') ? 'active' : '' }}" title="Categories">
    <i class="ph ph-squares-four"></i>
...
<a href="{{ route('admin.hr-users.index') }}" class="sidebar-link {{ request()->routeIs('admin.hr-users.*') ? 'active' : '' }}" title="HR Users">
    <i class="ph ph-users"></i>
    <span class="sidebar-link-text truncate">HR Users</span>
</a>
<a href="{{ route('admin.staff.index') }}" class="sidebar-link {{ request()->routeIs('admin.staff.*') ? 'active' : '' }}" title="Staff Registry">
...
<a href="{{ route('admin.branches.index') }}" class="sidebar-link {{ request()->routeIs('admin.branches.*') ? 'active' : '' }}" title="Branches">
...
<a href="{{ route('admin.access-control.password-reset') }}" class="sidebar-link {{ request()->routeIs('admin.access-control.password-reset') ? 'active' : '' }}" title="Password Reset">
    <i class="ph ph-key"></i>
    <span class="sidebar-link-text truncate">Password Reset</span>
</a>
<a href="{{ route('admin.access-control.sessions') }}" class="sidebar-link {{ request()->routeIs('admin.access-control.sessions') ? 'active' : '' }}" title="Active Sessions">
...
<a href="{{ route('admin.impersonate', 'faculty') }}" target="_blank" class="sidebar-link" title="Faculty">
...
<a href="{{ route('admin.impersonate', 'admission') }}" target="_blank" class="sidebar-link" title="Admission">
    <i class="ph ph-phone"></i>
    <span class="sidebar-link-text truncate">Admission</span>
    <i class="ph ph-arrow-square-out sidebar-link-external ml-auto text-xs opacity-50"></i>
</a>
<a href="{{ route('admin.impersonate', 'ads') }}" target="_blank" class="sidebar-link" title="Ads">
    <i class="ph ph-megaphone"></i>
    <span class="sidebar-link-text truncate">Ads</span>
    <i class="ph ph-arrow-square-out sidebar-link-external ml-auto text-xs opacity-50"></i>
</a>
<a href="{{ route('admin.impersonate', 'hr') }}" target="_blank" class="sidebar-link" title="HR Panel">
