...
@if($active)
    <span class="inline-flex items-center gap-1 px-2 py-0.5 rounded-full bg-primary-50 border border-emerald-100 text-emerald-700 font-bold text-[10px] uppercase tracking-wide">
