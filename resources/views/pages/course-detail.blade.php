        ...
        <div class="space-y-6" id="sticky-sidebar">
            <div class="sticky top-24 space-y-5">
                ...
                <div class="bg-gradient-to-br from-primary to-primary-700 rounded-2xl p-5 text-white text-center">
                    ...
                    <a href="tel:{{ config('contact.phone_tel') }}" class="inline-flex items-center gap-2 bg-white text-primary font-bold text-sm px-5 py-2.5 rounded-xl hover:bg-primary-50 transition-colors">
