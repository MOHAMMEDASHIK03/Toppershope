...
<section id="about-hero" class="relative overflow-hidden bg-gradient-to-b from-slate-50 via-white to-white border-b border-slate-100">
    <div class="absolute -top-28 -left-16 w-72 h-72 rounded-full bg-primary-100/70 blur-3xl pointer-events-none"></div>
    ...
    <div class="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 md:py-24 flex flex-col md:flex-row items-center gap-10">
        <div class="md:w-1/2">
            ...
            <h1 id="hero-title" class="text-4xl md:text-6xl font-black text-slate-900 leading-tight mb-5">
                About
                <span class="text-transparent bg-clip-text bg-gradient-to-r from-primary to-primary-600">Topper's Hope</span>
            </h1>
            ...
            <div id="hero-btns" class="mt-8 flex flex-wrap gap-3">
                <a href="{{ route('register') }}" class="px-7 py-3 bg-primary hover:bg-primary-700 text-white font-bold rounded-xl transition-all shadow-[0_8px_24px_rgba(37,99,235,0.28)]">Start Learning</a>
        ...
        <div class="md:w-1/2 w-full" id="hero-visual">
            <div class="grid grid-cols-2 gap-4">
                ...
                <div class="bg-white border border-slate-200 rounded-2xl p-5 shadow-sm hover:shadow-md transition-all hero-card">
                    <div class="w-10 h-10 mb-3 rounded-xl bg-primary-50 border border-primary-100 flex items-center justify-center">
            ...
            <div class="lg:col-span-4 gsap-reveal lg:sticky lg:top-28">
                <div class="relative bg-gradient-to-br from-primary via-[#2233ff] to-primary-800 rounded-3xl p-8 text-white shadow-2xl overflow-hidden">
                    ...
                    <div class="relative z-10">
                        ...
                        <p class="text-primary-200 text-sm mb-6 leading-relaxed">Everything you should know about us at a glance.</p>
                        ...
                        <ul class="space-y-4 text-sm mb-6">
                            ...
                            <li class="flex items-start gap-3">
                                <span class="w-6 h-6 rounded-lg bg-white/15 border border-white/20 shrink-0 mt-0.5 flex items-center justify-center">
                                    <svg class="w-3.5 h-3.5 text-primary-200" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.8" d="M5 13l4 4L19 7"></path></svg>
                                </span>
                                <div>
                                    <span class="text-primary-200 text-xs uppercase tracking-wide">{{ $f[0] }}</span>
                        ...
                        <div class="w-full h-px bg-white/20 mb-6"></div>
                        <a href="{{ route('contact') }}" class="block text-center py-3 bg-white text-primary font-black rounded-xl hover:bg-primary-50 transition-all">Get in Touch →</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 gsap-stagger-parent">
            ...
            <div class="gsap-stagger-child bg-white p-7 rounded-2xl border border-gray-100 shadow-sm hover:shadow-md hover:-translate-y-1 transition-all">
                <span class="w-11 h-11 mb-4 rounded-xl bg-primary-50 border border-primary-100 flex items-center justify-center">
                    <svg class="w-5 h-5 text-primary-600" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.8" d="M5 13l4 4L19 7"></path></svg>
                </span>
...
<section class="py-20 bg-white border-t border-gray-100">
    <div class="max-w-3xl mx-auto px-4 text-center gsap-reveal">
        ...
        <div class="flex flex-col sm:flex-row gap-4 justify-center">
            <a href="{{ route('register') }}" class="px-10 py-4 bg-primary hover:bg-primary-700 text-white font-black rounded-xl transition-all shadow-[0_4px_14px_rgba(27,42,255,0.39)]">Start Free Today →</a>
