...
<div class="min-h-[86vh] relative overflow-hidden py-10 sm:py-14">
    <div class="absolute top-0 right-0 w-[30rem] h-[30rem] bg-indigo-100/60 blur-3xl rounded-full -translate-y-1/2 translate-x-1/3 pointer-events-none"></div>
    <div class="absolute bottom-0 left-0 w-[26rem] h-[26rem] bg-fuchsia-100/60 blur-3xl rounded-full translate-y-1/2 -translate-x-1/3 pointer-events-none"></div>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        <div class="grid lg:grid-cols-5 gap-8 items-stretch">
            <div class="hidden lg:flex lg:col-span-2 rounded-3xl bg-gradient-to-br from-[#111827] via-[#1f2937] to-[#312e81] text-white p-10 shadow-[0_20px_55px_rgba(17,24,39,0.35)]">
                <div class="my-auto">
                    <span class="inline-flex items-center gap-2 text-[11px] font-extrabold uppercase tracking-[0.14em] bg-white/10 border border-white/20 rounded-full px-3 py-1 mb-6">
                        <span class="w-1.5 h-1.5 rounded-full bg-cyan-200"></span>
            ...
            <div class="lg:col-span-3 rounded-3xl p-[1px] bg-gradient-to-br from-slate-200 via-indigo-200/70 to-sky-200/70">
                <div class="h-full rounded-3xl bg-white/92 backdrop-blur-md border border-white/80 p-6 sm:p-8 shadow-[0_14px_35px_rgba(15,23,42,0.10)]">
                    ...
                    <form method="POST" action="{{ route('register') }}" class="space-y-6">
                        ...
                        <div class="pt-2">
                            <button type="submit" class="w-full flex justify-center py-4 px-4 border border-transparent rounded-xl shadow-[0_10px_25px_rgba(79,70,229,0.30)] text-sm font-bold text-white bg-gradient-to-r from-primary to-indigo-600 hover:from-indigo-600 hover:to-primary focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary transition-all">
                        ...
                        <div class="text-center mt-6 border-t border-slate-100 pt-6">
                            <p class="text-sm text-slate-500 font-medium">
                                Already enrolled? 
                                <a href="{{ route('login') }}" class="font-bold text-primary hover:text-blue-700 transition-colors">Sign in here</a>
                            </p>
                        </div>
                    </form>
                </div>
