        ...
        <div class="md:w-1/2 flex justify-center items-center" id="hero-3d">
            <div class="relative w-full max-w-md bg-white border border-slate-200 rounded-3xl p-6 shadow-lg">
                <div class="grid grid-cols-1 gap-3">
                    <?php $__currentLoopData = ['How do I choose the right course?', 'Can I switch batches after joining?', 'Are classes recorded for revision?']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $q): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="rounded-xl border border-slate-200 bg-slate-50 px-4 py-3 text-sm font-semibold text-slate-700"><?php echo e($q); ?></div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
            ...
            <div class="lg:col-span-8 gsap-reveal">
                ...
                <div class="mt-10 grid grid-cols-3 gap-6">
                    <?php $__currentLoopData = [['val'=>'15+','label'=>'Questions Answered'],['val'=>'< 2 hrs','label'=>'Avg. Response Time'],['val'=>'24×7','label'=>'Support Available']]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $stat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <div class="relative bg-gradient-to-br from-primary via-[#2233ff] to-[#7B61FF] rounded-3xl p-8 text-white shadow-2xl overflow-hidden">
                    ...
                    <div class="relative z-10">
                        ...
                        <div class="flex gap-3">
                            ...
                            <a href="<?php echo e($social['href']); ?>" aria-label="<?php echo e($social['label']); ?>"
                               class="w-10 h-10 rounded-full border border-white/30 bg-white/10 hover:bg-white/25 flex items-center justify-center transition-all hover:scale-110 hover:border-white/50">
                                <svg class="w-5 h-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="<?php echo e($social['icon']); ?>"></path>
                                </svg>
                            </a>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </div>
...
<div class="bg-slate-50 border-y border-gray-200 py-5 sticky top-20 z-30" x-data>
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex flex-wrap gap-3 items-center justify-center">
            <?php $__currentLoopData = ['All','Admissions','Courses','Payments','Results','Technical']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <button
                class="faq-filter-btn px-5 py-2 rounded-full border text-sm font-semibold transition-all <?php echo e($loop->first ? 'bg-primary text-white border-primary shadow-md' : 'bg-white border-gray-200 text-gray-600 hover:border-primary hover:text-primary'); ?>"
                data-filter="<?php echo e(strtolower($cat)); ?>"
                onclick="filterFaq(this, '<?php echo e(strtolower($cat)); ?>')">
                <?php echo e($cat); ?>
            ...
            <div class="lg:col-span-2" x-data="{ open: null }">
                ...
                <div class="space-y-3" id="faq-list">
                    ...
                    <div class="faq-item gsap-stagger-child border border-gray-200 rounded-2xl overflow-hidden hover:border-primary/40 transition-all hover:shadow-sm"
                         data-cat="<?php echo e($faq['cat']); ?>">
                        <button
                            @click="open = open === <?php echo e($i); ?> ? null : <?php echo e($i); ?>"
                            class="w-full flex items-start justify-between gap-4 p-6 text-left"
                            :class="open === <?php echo e($i); ?> ? 'bg-primary/5' : 'bg-white hover:bg-gray-50'"
                        >
                            <span class="font-bold text-gray-900 leading-snug"><?php echo e($faq['q']); ?></span>
                            <div class="shrink-0 w-7 h-7 rounded-full flex items-center justify-center transition-all duration-300"
                                 :class="open === <?php echo e($i); ?> ? 'bg-primary rotate-45' : 'bg-gray-100'">
                                <svg class="w-4 h-4 transition-colors" :class="open === <?php echo e($i); ?> ? 'text-white' : 'text-gray-500'" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M12 4v16m8-8H4"></path>
                                </svg>
                            </div>
                        </button>
                        <div x-show="open === <?php echo e($i); ?>"
                            ...
                            <div class="border-l-4 border-primary pl-4 ml-0 mt-1">
                                <p class="text-gray-600 leading-relaxed"><?php echo e($faq['a']); ?></p>
                            </div>
                        </div>
                    </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                ...
                <div class="sticky top-40 space-y-6">
                    <div class="bg-gradient-to-br from-primary via-[#2233ff] to-[#7B61FF] rounded-3xl p-7 text-white shadow-xl relative overflow-hidden">
                        ...
                        <div class="relative z-10">
                            ...
                            <?php $__currentLoopData = range(1,4); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $s): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('layouts.public', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Lama Projects\toppershope-website\resources\views/pages/faq.blade.php ENDPATH**/ ?>