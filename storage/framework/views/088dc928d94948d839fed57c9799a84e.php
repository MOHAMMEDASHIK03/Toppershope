<style>
    ...
    .bg-primary\/10           { background-color: rgba(249,115,22,0.10) !important; }
    .bg-primary\/20           { background-color: rgba(249,115,22,0.20) !important; }
    .shadow-primary\/20       { --tw-shadow-color: rgba(249,115,22,0.20); }
    ...
    .focus\:ring-primary\/30:focus { --tw-ring-color: rgba(249,115,22,0.3); }
    ...
    .fp-banner-google { background:linear-gradient(135deg,#1d4ed8,#4338ca); color:#fff; border-radius:var(--fp-radius); padding:1.5rem; display:flex; align-items:center; justify-content:space-between; gap:1rem; margin-bottom:1.5rem; box-shadow:0 4px 24px rgba(29,78,216,.25); }
    ...
    .fp-banner-btn { flex-shrink:0; background:#fff; color:#1d4ed8; font-weight:700; font-size:.875rem; padding:.65rem 1.25rem; border-radius:.75rem; text-decoration:none; white-space:nowrap; display:inline-block; }
    .fp-banner-btn:hover { background:#eff6ff; color:#1e40af; }
    ...
    .fp-stat-icon.orange { background:#fff7ed; color:#ea580c; }
    .fp-stat-icon.blue   { background:#eff6ff; color:#2563eb; }
    .fp-stat-icon.green  { background:#f0fdf4; color:#16a34a; }
    .fp-stat-icon.purple { background:#faf5ff; color:#9333ea; }
    ...
    .fp-btn-primary { display:inline-flex; align-items:center; gap:.5rem; background:var(--fp-primary); color:#fff; font-weight:700; font-size:.875rem; padding:.65rem 1.25rem; border-radius:.75rem; border:none; cursor:pointer; text-decoration:none; transition:background .15s,box-shadow .15s,transform .15s; box-shadow:0 2px 8px rgba(249,115,22,.3); }
    .fp-btn-primary:hover { background:var(--fp-primary-dk); box-shadow:0 4px 16px rgba(249,115,22,.35); transform:translateY(-1px); color:#fff; }
    .fp-btn-primary:disabled { opacity:.5; cursor:not-allowed; transform:none; }

    .fp-btn-blue { display:inline-flex; align-items:center; gap:.5rem; background:linear-gradient(135deg,#1d4ed8,#4338ca); color:#fff; font-weight:700; font-size:.875rem; padding:.65rem 1.25rem; border-radius:.75rem; border:none; cursor:pointer; text-decoration:none; transition:opacity .15s,transform .15s; box-shadow:0 2px 8px rgba(29,78,216,.25); }
    .fp-btn-blue:hover { opacity:.9; transform:translateY(-1px); color:#fff; }
    .fp-btn-blue:disabled { opacity:.5; cursor:not-allowed; transform:none; }
    ...
    .fp-meeting-card-bar   { height:6px; background:linear-gradient(90deg,#3b82f6,#6366f1); }
    ...
    .fp-badge.batch     { background:#dbeafe; color:#1d4ed8; }
    .fp-badge.one-on-one { background:#f3e8ff; color:#7c3aed; }
    ...
    .fp-input:focus,.fp-select:focus,.fp-textarea:focus { border-color:var(--fp-primary); background:#fff; box-shadow:0 0 0 3px rgba(249,115,22,.12); }
    ...
    .fp-type-option.selected-primary { border-color:var(--fp-primary); background:#fff7ed; }
    .fp-type-option.selected-blue    { border-color:#3b82f6; background:#eff6ff; }
...
<?php /**PATH D:\Lama Projects\toppershope-website\resources\views/components/panel/faculty-compat-styles.blade.php ENDPATH**/ ?>