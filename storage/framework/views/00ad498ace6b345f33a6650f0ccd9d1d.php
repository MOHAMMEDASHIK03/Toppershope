...
<div <?php echo e($attributes->merge(['class' => $height . ' relative overflow-hidden bg-slate-100'])); ?>>
    <?php if($imageUrl): ?>
        <img
    ...
    >
        <span class="text-5xl font-bold <?php echo e($palette['text']); ?> select-none drop-shadow-sm"><?php echo e($initial); ?></span>
    </div>
</div>
<?php /**PATH D:\Lama Projects\toppershope-website\resources\views/components/course/cover.blade.php ENDPATH**/ ?>