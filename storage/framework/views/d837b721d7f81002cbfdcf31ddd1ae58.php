                    ...
                    <tr>
                        ...
                        <td>
                            <?php if($log->user): ?>
                                ...
                                <span class="text-xs text-primary-700 font-medium"><?php echo e(str_replace('App\\Models\\', '', $log->user_type)); ?><?php if($log->user_id): ?> #<?php echo e($log->user_id); ?><?php endif; ?></span>
                            <?php else: ?>
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Lama Projects\Toppershope\resources\views/admin/audit-logs/index.blade.php ENDPATH**/ ?>