...
<div x-data="{
    ...
    slides: [
        ...
        { color: 'from-primary-600 via-primary-700 to-primary-800', badge: 'National Scholarship', title: 'SCHOLARSHIP TEST LIVE', sub: 'Get up to 90% fee waiver. Register free and prove your potential.', cta: 'Register', href: '<?php echo e(route('register')); ?>' }
    ],
    startProgress() {
...
<section id="categories" class="relative py-20 bg-[linear-gradient(180deg,#F5F0FF_0%,#ffffff_55%,#F5F0FF_100%)] overflow-hidden">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-5 gsap-stagger-parent">
            ...
            <a href="<?php echo e(route('category.show', $cat)); ?>" class="gsap-stagger-child group relative rounded-2xl p-[1px] bg-gradient-to-br from-white via-primary-100/70 to-primary-100/80 hover:from-primary-200 hover:to-primary-200 transition-all duration-300">
                <div class="relative h-full min-h-[205px] rounded-2xl border border-white/80 bg-white/85 backdrop-blur-sm shadow-[0_12px_30px_rgba(15,23,42,0.06)] group-hover:shadow-[0_20px_35px_rgba(119,35,214,0.16)] group-hover:-translate-y-1 transition-all duration-300 p-5 flex flex-col">
                    ...
                    <div class="mb-4">
                        <div class="w-12 h-12 rounded-xl bg-gradient-to-br <?php echo e($cat->landing('icon_bg', 'from-primary-500 to-primary-500')); ?> text-white shadow-md flex items-center justify-center shrink-0">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 gsap-stagger-parent">
            ...
            <div class="gsap-stagger-child relative bg-white rounded-2xl border-2 border-amber-200 p-6 shadow-sm hover:shadow-lg transition-all flex flex-col gap-3 overflow-hidden group">
                ...
                <?php endif; ?>
                <?php if($ub->mode): ?>
                <span class="text-[10px] font-bold bg-primary-50 text-primary border border-primary-100 px-2 py-0.5 rounded-full self-start"><?php echo e($ub->mode); ?></span>
                <?php endif; ?>
        ...
        <div class="gsap-reveal relative rounded-3xl overflow-hidden border border-primary-200/70 bg-gradient-to-r from-primary-50 via-primary-50 to-violet-50 shadow-[0_14px_35px_rgba(119,35,214,0.16)]">
            ...
            <div class="grid md:grid-cols-2 items-center gap-8 px-6 py-8 md:px-10 md:py-10 relative">
                ...
                <div class="order-1 md:order-2">
                    ...
                    <a href="<?php echo e(route('contact')); ?>" class="inline-flex items-center gap-2 px-7 py-3 bg-primary-600 hover:bg-primary-700 text-white font-bold rounded-xl transition-all shadow-[0_8px_22px_rgba(119,35,214,0.35)]">
                        Book Now
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M14 5l7 7m0 0l-7 7m7-7H3"></path></svg>
                    </a>
                </div>
        ...
        <div class="gsap-reveal relative rounded-3xl overflow-hidden border border-primary-200/70 bg-gradient-to-r from-primary-50 via-primary-50 to-primary-50 shadow-[0_14px_35px_rgba(168,85,247,0.16)]">
            ...
            <div class="grid md:grid-cols-2 items-center gap-8 px-6 py-8 md:px-10 md:py-10 relative">
                <div>
                    ...
                    <a href="<?php echo e(route('contact')); ?>" class="inline-flex items-center gap-2 px-7 py-3 bg-primary-600 hover:bg-primary-700 text-white font-bold rounded-xl transition-all shadow-[0_8px_22px_rgba(192,38,211,0.35)]">
                        Request Callback
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M14 5l7 7m0 0l-7 7m7-7H3"></path></svg>
                    </a>
                </div>
                            ...
                            <div class="flex items-start justify-between">
                                <div class="flex items-center gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-[11px] text-primary-600 font-bold"><?php echo e($courseName); ?></p>
                                    </div>
                                </div>
                                <span class="px-2.5 py-1 text-[10px] font-black rounded-full bg-primary-50 text-primary-700 border border-primary-100"><?php echo e($rankOrScore); ?></span>
                            </div>
...
<?php echo $__env->make('layouts.public', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Lama Projects\Toppershope\resources\views/welcome.blade.php ENDPATH**/ ?>