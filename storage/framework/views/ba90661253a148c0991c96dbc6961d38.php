    ...
    <div class="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 md:py-24 flex flex-col md:flex-row items-center gap-10">
        <div class="md:w-1/2">
            ...
            <div id="hero-btns" class="mt-8 flex flex-wrap gap-3">
                <a href="<?php echo e(route('register')); ?>" class="px-7 py-3 bg-primary hover:bg-blue-700 text-white font-bold rounded-xl transition-all shadow-[0_8px_24px_rgba(37,99,235,0.28)]">Start Learning</a>
                <a href="<?php echo e(route('contact')); ?>" class="px-7 py-3 bg-white border border-slate-200 hover:border-slate-300 text-slate-700 font-bold rounded-xl transition-all">Contact Team</a>
            </div>
        </div>

        <div class="md:w-1/2 w-full" id="hero-visual">
            <div class="grid grid-cols-2 gap-4">
                <?php $__currentLoopData = [['Mission','Make top-quality mentoring available at scale.'],['Vision','Help every student compete with confidence.'],['Method','Concept clarity, practice, and feedback loops.'],['Outcome','Consistent rank improvement across exams.']]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $card): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="bg-white border border-slate-200 rounded-2xl p-5 shadow-sm hover:shadow-md transition-all hero-card">
                    ...
                    <h4 class="font-black text-slate-900 text-sm mb-1"><?php echo e($card[0]); ?></h4>
                    <p class="text-slate-500 text-xs leading-relaxed"><?php echo e($card[1]); ?></p>
                </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
            ...
            <div class="lg:col-span-8 gsap-reveal">
                ...
                <div class="mt-10 grid grid-cols-3 gap-6">
                    <?php $__currentLoopData = [['val'=>'1M+','label'=>'Students Taught'],['val'=>'500+','label'=>'Cities Reached'],['val'=>'98%','label'=>'Student Satisfaction']]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $stat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="text-center bg-gradient-to-b from-blue-50 to-white border border-blue-100 rounded-2xl py-5 px-4">
                        <p class="text-2xl font-black text-primary"><?php echo e($stat['val']); ?></p>
                        <p class="text-xs text-gray-500 font-semibold mt-1 uppercase tracking-wide"><?php echo e($stat['label']); ?></p>
                    </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
            </div>
                ...
                <div class="relative bg-gradient-to-br from-primary via-[#2233ff] to-[#7B61FF] rounded-3xl p-8 text-white shadow-2xl overflow-hidden">
                    ...
                    <div class="relative z-10">
                        ...
                        <ul class="space-y-4 text-sm mb-6">
                            <?php $__currentLoopData = [['Founded','2022'],['Headquarters','Tamil Nadu, India'],['Programs','JEE, NEET, UPSC, SSC, NDA & more'],['Faculty','50+ Expert Educators'],['Students','1 Million+ Enrolled'],['Top Results','AIR under 100 achieved']]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $f): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <li class="flex items-start gap-3">
                                ...
                                <div>
                                    <span class="text-blue-200 text-xs uppercase tracking-wide"><?php echo e($f[0]); ?></span>
                                    <p class="font-bold text-white"><?php echo e($f[1]); ?></p>
                                </div>
                            </li>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </ul>
                        <div class="w-full h-px bg-white/20 mb-6"></div>
                        <a href="<?php echo e(route('contact')); ?>" class="block text-center py-3 bg-white text-primary font-black rounded-xl hover:bg-blue-50 transition-all">Get in Touch →</a>
                    </div>
                </div>
            </div>
        </div>
...
<section class="py-16 bg-gray-900">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
            <?php $__currentLoopData = [['val'=>'1M+','label'=>'Students Taught'],['val'=>'500+','label'=>'Cities Reached'],['val'=>'50+','label'=>'Expert Faculty'],['val'=>'98%','label'=>'Success Rate']]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $s): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="gsap-reveal">
                <p class="text-4xl md:text-5xl font-black text-white mb-2"><?php echo e($s['val']); ?></p>
                <p class="text-gray-400 font-semibold text-sm uppercase tracking-wider"><?php echo e($s['label']); ?></p>
            </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </div>
    </div>
...
<?php $team = [['name'=>'Arjun Mehta','role'=>'Founder & CEO','bg'=>'bg-blue-100','letter'=>'AM','desc'=>'IIT Bombay, 7 yrs EdTech'],['name'=>'Priya Sharma','role'=>'Head of Academics','bg'=>'bg-red-100','letter'=>'PS','desc'=>'AIIMS Delhi, NEET AIR 12'],['name'=>'Rohan Das','role'=>'CTO & Product','bg'=>'bg-purple-100','letter'=>'RD','desc'=>'IIT Delhi, Ex-Google Eng'],['name'=>'Anika Singh','role'=>'Head of Faculty','bg'=>'bg-green-100','letter'=>'AS','desc'=>'IIT KGP, 10+ yrs teaching']]; ?>
            ...
            <div class="gsap-stagger-child group text-center">
                <div class="relative mx-auto mb-5 w-24 h-24 <?php echo e($person['bg']); ?> rounded-3xl flex items-center justify-center text-2xl font-black text-gray-700 shadow-sm group-hover:shadow-lg group-hover:-translate-y-2 transition-all">
                    <?php echo e($person['letter']); ?>

                </div>
                <h3 class="font-black text-gray-900 text-lg"><?php echo e($person['name']); ?></h3>
                <p class="text-primary font-bold text-sm"><?php echo e($person['role']); ?></p>
                <p class="text-gray-400 text-xs mt-1"><?php echo e($person['desc']); ?></p>
            </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </div>
    </div>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 gsap-stagger-parent">
            ...
            <div class="gsap-stagger-child bg-white p-7 rounded-2xl border border-gray-100 shadow-sm hover:shadow-md hover:-translate-y-1 transition-all">
                ...
                <h3 class="font-black text-gray-900 mb-2"><?php echo e($v['title']); ?></h3>
                <p class="text-sm text-gray-500 leading-relaxed"><?php echo e($v['desc']); ?></p>
            </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </div>
    </div>
...
<section class="py-20 bg-white border-t border-gray-100">
    <div class="max-w-3xl mx-auto px-4 text-center gsap-reveal">
        ...
        <div class="flex flex-col sm:flex-row gap-4 justify-center">
            <a href="<?php echo e(route('register')); ?>" class="px-10 py-4 bg-primary hover:bg-blue-700 text-white font-black rounded-xl transition-all shadow-[0_4px_14px_rgba(27,42,255,0.39)]">Start Free Today →</a>
            <a href="<?php echo e(route('faq')); ?>" class="px-10 py-4 bg-white border border-gray-200 text-gray-700 font-bold rounded-xl hover:bg-gray-50 transition-all">Read FAQs</a>
        </div>
    </div>
</section>
...
<?php echo $__env->make('layouts.public', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Lama Projects\toppershope-website\resources\views/pages/about.blade.php ENDPATH**/ ?>