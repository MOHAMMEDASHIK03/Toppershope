<?php $__env->startSection('title', 'Careers & Job Opportunities'); ?>
...
<section id="careers-hero" class="relative overflow-hidden bg-gradient-to-b from-slate-50 via-white to-white border-b border-slate-100">
    ...
    <div class="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 md:py-28 text-center">
        ...
        <div id="hero-btns" class="flex flex-wrap gap-4 justify-center">
            ...
            <a href="<?php echo e(route('about')); ?>" class="px-8 py-4 bg-white border border-slate-200 hover:border-slate-300 text-slate-700 font-bold rounded-xl transition-all">
...
<section id="open-positions" class="py-24 bg-white" x-data="{ activeDept: 'all' }">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="flex flex-col md:flex-row md:items-end justify-between mb-12 gap-6 gsap-reveal">
            ...
            <div class="flex flex-wrap gap-2">
                <button @click="activeDept = 'all'" :class="activeDept === 'all' ? 'bg-primary text-white shadow-md' : 'bg-slate-100 text-slate-600 hover:bg-slate-200'" class="px-5 py-2.5 rounded-full text-xs font-extrabold uppercase tracking-wider transition-all">
                    All Departments (<?php echo e($jobs->count()); ?>)
                </button>
                ...
                <button @click="activeDept = 'dept-<?php echo e($dept->id); ?>'" :class="activeDept === 'dept-<?php echo e($dept->id); ?>' ? 'bg-primary text-white shadow-md' : 'bg-slate-100 text-slate-600 hover:bg-slate-200'" class="px-5 py-2.5 rounded-full text-xs font-extrabold uppercase tracking-wider transition-all">
        ...
        <div class="space-y-6">
            ...
            <div x-show="activeDept === 'all' || activeDept === 'dept-<?php echo e($job->department_id); ?>'" 
                ...
                <div class="space-y-3 max-w-2xl">
                    <div class="flex flex-wrap items-center gap-3">
                        <span class="px-3 py-1 bg-blue-50 border border-blue-100 text-primary rounded-full text-[11px] font-black uppercase tracking-wider">
                            <?php echo e($job->department->name ?? 'General'); ?>
                        ...
                        <span class="px-3 py-1 bg-orange-50 border border-orange-100 text-orange-600 rounded-full text-[11px] font-black uppercase tracking-wider">
                            <?php echo e($job->vacancies); ?> Openings
                        </span>
                        <?php endif; ?>
                    </div>
                ...
                <div class="shrink-0 flex items-center">
                    <a href="<?php echo e(route('careers.apply', $job)); ?>" class="w-full md:w-auto text-center px-6 py-3.5 bg-slate-900 group-hover:bg-primary text-white font-extrabold text-xs uppercase tracking-widest rounded-xl transition-all shadow-md group-hover:shadow-lg group-hover:shadow-primary/20 flex items-center justify-center gap-2">
                        View &amp; Apply
            ...
            <div class="border-2 border-dashed border-slate-200 bg-slate-50/50 rounded-3xl p-12 text-center max-w-xl mx-auto flex flex-col items-center justify-center shadow-inner">
                ...
                <a href="<?php echo e(route('contact')); ?>" class="px-6 py-3 bg-white border border-slate-200 hover:border-slate-300 text-slate-700 font-bold rounded-xl transition-all shadow-sm">
                    Get in Touch
                </a>
            </div>
            <?php endif; ?>
...
<?php echo $__env->make('layouts.public', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Lama Projects\toppershope-website\resources\views/pages/careers.blade.php ENDPATH**/ ?>